...
for qfile in output/rep_0/structure_run_*_q; do
    ...
    echo -e "$ind_id\t$first_q" >> output/rep_0/all_query_Q_values.tsv
done
...
awk '{
    ...
    OFS="\t"
    print id, $1, $2
}' output/rep_0/all_query_Q_values.tsv > output/rep_0/all_query_Q_values_with_pop.tsv
